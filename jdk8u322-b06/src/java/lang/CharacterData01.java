...
class CharacterData01 extends CharacterData {
  ...
  // java GenerateCharacter -plane 1 -template e:/jenkins/tmp/workspace/build/src/jdk/make/data/characterdata/CharacterData01.java.template -spec e:/jenkins/tmp/workspace/build/src/jdk/make/data/unicodedata/UnicodeData.txt -specialcasing e:/jenkins/tmp/workspace/build/src/jdk/make/data/unicodedata/SpecialCasing.txt -proplist e:/jenkins/tmp/workspace/build/src/jdk/make/data/unicodedata/PropList.txt -o e:/jenkins/tmp/workspace/build/src/build/windows-x86_64-normal-server-release/jdk/gensrc/java/lang/CharacterData01.java -string -usecharforbyte 11 4 1
